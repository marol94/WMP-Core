...
RESOURCES += src/qt/wmp.qrc src/qt/wmp_locale.qrc

TRANSLATIONS += src/qt/locale/wmp_bg.ts \
                src/qt/locale/wmp_de.ts \
                src/qt/locale/wmp_en.ts \
                src/qt/locale/wmp_es.ts \
                src/qt/locale/wmp_fi.ts \
                src/qt/locale/wmp_fr.ts \
                src/qt/locale/wmp_it.ts \
                src/qt/locale/wmp_ja.ts \
                src/qt/locale/wmp_pl.ts \
                src/qt/locale/wmp_pt.ts \
                src/qt/locale/wmp_ru.ts \
                src/qt/locale/wmp_sk.ts \
                src/qt/locale/wmp_sv.ts \
                src/qt/locale/wmp_vi.ts \
                src/qt/locale/wmp_zh_CN.ts \
                src/qt/locale/wmp_zh_TW.ts
