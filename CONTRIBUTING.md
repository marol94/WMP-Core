Contributing to WMP Core
============================

The WMP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WMP Core project, and is not to be
confused with overall WMP Network Protocol consensus changes.

Whether a pull request is merged into WMP Core rests with the project merge
...
Patches that change WMP consensus rules are considerably more involved than
...
Where a patch set proposes to change the WMP consensus, it must have been
...
The project leader is the release manager for each WMP Core release.
