...
public:
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the WMP debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzpivbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zWMP Backup Path:", 0));
