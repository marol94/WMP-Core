...
// Copyright (c) 2015-2018 The WMP developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WMP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WMP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and WMP: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWMP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WMP Core"), this);
    aboutAction->setStatusTip(tr("Show information about WMP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WMP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WMP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WMP addresses"));
    ...
    openAction->setStatusTip(tr("Open a WMP: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the WMP Core help message to get a list with possible WMP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WMP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WMP network", "", count));
}
...
{
    QString strTitle = tr("WMP Core"); // default title
