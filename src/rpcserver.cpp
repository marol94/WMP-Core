...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WMP features */
        {"wmp", "masternode", &masternode, true, true, false},
        {"wmp", "listmasternodes", &listmasternodes, true, true, false},
        {"wmp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wmp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wmp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wmp", "masternodedebug", &masternodedebug, true, true, false},
        {"wmp", "startmasternode", &startmasternode, true, true, false},
        {"wmp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wmp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wmp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wmp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wmp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wmp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wmp", "mnbudget", &mnbudget, true, true, false},
        {"wmp", "preparebudget", &preparebudget, true, true, false},
        {"wmp", "submitbudget", &submitbudget, true, true, false},
        {"wmp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wmp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wmp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wmp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wmp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wmp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wmp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wmp", "checkbudgets", &checkbudgets, true, true, false},
        {"wmp", "mnsync", &mnsync, true, true, false},
        {"wmp", "spork", &spork, true, true, false},
        {"wmp", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"wmp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wmpd, or the -server option to wmp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wmp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17338/\n";
}
