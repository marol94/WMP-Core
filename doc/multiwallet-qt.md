...
In order to support loading of multiple wallets in wmp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wmp.cpp.
...
Changes to wmp.cpp
----------------------
wmp.cpp is the entry point into wmp-qt, and as such, will require some minor modifications to provide hooks for
